						...
						if ( \Pressbooks\Modules\Export\Export::shouldParseSubsections() === true ) {
							...
							if ( $sections ) {
								...
								foreach ( $sections as $id => $title ) {
									$li_sections .= '<li class="section"><a href="#' . $id . '"><span class="toc-subsection-title">' . Sanitize\decode( $title ) . '</span></a></li>';
								}
								$li_sections .= '</ol>';
				...
				foreach ( $struct as $val ) {
					...
					if ( \Pressbooks\Modules\Export\Export::shouldParseSubsections() === true ) {
						...
						if ( $sections ) {
							$li_sections = '<ol class="sections">';
							foreach ( $sections as $id => $title ) {
								$li_sections .= '<li class="section"><a href="#' . $id . '"><span class="toc-subsection-title">' . $title . '</span></a></li>';
							}
							$li_sections .= '</ol>';
							$li->appendContent( $li_sections );
						}
